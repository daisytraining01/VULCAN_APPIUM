...
public class pageObjects_Mohan  {
	
	
 public static final	By clikCheckatabase = By.id("android:id/button1");
 public static final	By searchText = By.id("com.wordwebsoftware.android.wordweb:id/search_src_text");
 public static final	By clickFirstResult = By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.support.v4.widget.DrawerLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.ListView/android.widget.LinearLayout[1]/android.widget.LinearLayout");
 public static final	By bookMark = By.id("add_to_bookmark_menu");
 public static final	By moreOptions = By.xpath("//android.widget.ImageView[@content-desc=\"More options\"]");
...
//
 ...
 public static final    By noun = By.id("com.wordwebsoftware.android.wordweb:id/search_noun_button");
 public static final    By verb = By.id("com.wordwebsoftware.android.wordweb:id/search_verb_button");
 public static final    By adjuctive = By.id("com.wordwebsoftware.android.wordweb:id/search_adj_button");
